...
/**
 * /quakecraft (alias /qc) — setup + control commands.
 *
 * <p>Setup workflow:
 * <ol>
 *   <li>/qc setworld &lt;world&gt;</li>
 *   <li>/qc setspawn — repeat 8+ times for spawn variety</li>
 *   <li>/qc setpowerup &lt;name&gt; — at locations where powerups should drop</li>
 *   <li>/qc status — verify configuration</li>
 * </ol>
 */
public class QuakeCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "setpowerup" -> {
                if (!(sender instanceof Player p)) { sender.sendMessage("Alleen spelers."); return true; }
                if (args.length < 2) {
                    sender.sendMessage(ChatColor.RED + "Gebruik: /qc setpowerup <naam>");
                    return true;
                }
            ...
            case "removepowerup" -> {
                if (args.length < 2) {
                    sender.sendMessage(ChatColor.RED + "Gebruik: /qc removepowerup <naam>");
                    return true;
                }
            ...
            case "listpowerups" -> {
                ...
                if (locs.isEmpty()) {
                    sender.sendMessage(ChatColor.GRAY + "Geen powerup locaties.");
                } else {
                    ...
                    for (var e : locs.entrySet()) {
                        ...
                        sender.sendMessage(ChatColor.YELLOW + e.getKey()
                                + ChatColor.GRAY + " bij " + loc.getBlockX() + "," + loc.getBlockY() + "," + loc.getBlockZ());
                    }
                }
            }
            ...
            case "status" -> {
                ...
                sender.sendMessage(ChatColor.YELLOW + "State: " + ChatColor.RED + "Not yet implemented (patch 10)");
            ...
            case "start", "stop" -> {
                sender.sendMessage(ChatColor.YELLOW + "Game loop nog niet geïmplementeerd — komt in patch 10.");
            }
    ...
    private void usage(CommandSender s) {
        s.sendMessage(ChatColor.RED + "Gebruik: /qc <setworld|setspawn|clearspawns"
    ...
    public List<String> onTabComplete(CommandSender s, Command c, String l, String[] args) {
        if (args.length == 1)
            return List.of("setworld", "setspawn", "clearspawns",
                    "setpowerup", "removepowerup", "clearpowerups", "listpowerups",
                    "status", "reload", "start", "stop").stream()
